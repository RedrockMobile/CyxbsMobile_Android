package com.mredrock.cyxbs.ufield.ui.fragment.campaignfragment
...
import com.mredrock.cyxbs.ufield.adapter.MsgAdapter
...
class PublishFragment : BaseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mViewModel.publishMsg.observe(viewLifecycleOwner) {
            if (it.isEmpty()) {
                mHaveMessage.gone()
                mNoMessage.visible()
            } else {
