...
import kotlinx.android.synthetic.main.volunteer_item_pop_window.view.*
...
class PopupWindowRvAdapter(private var dataList: List<String>, private val onItemClick: (String) -> Unit) : RecyclerView.Adapter<PopupWindowRvAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.itemView.tv_year.text = holder.itemView.context.getString(R.string.volunteer_string_year, dataList[position])
