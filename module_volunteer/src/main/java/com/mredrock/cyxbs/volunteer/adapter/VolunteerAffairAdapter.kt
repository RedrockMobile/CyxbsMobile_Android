 ...
 */
class VolunteerAffairAdapter(private val dataList: List<VolunteerAffair>, private val onItemClick: (Int) -> Unit) : RecyclerView.Adapter<VolunteerAffairAdapter.ViewHolder>() {
