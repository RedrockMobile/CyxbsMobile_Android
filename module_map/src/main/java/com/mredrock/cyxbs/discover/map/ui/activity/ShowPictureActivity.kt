...
class ShowPictureActivity : BaseActivity() {
    ...
    companion object {
        ...
        fun activityStart(context: Context?, images: ArrayList<String>, position: Int) {
            context?.startActivity<ShowPictureActivity>(
                Pair("images", images),
                Pair("picturePosition", position)
            )
        }
    }
                ...
                MapDialog.show(this@ShowPictureActivity,
                    ...
                    object : OnSelectListener {
                        ...
                        override fun onPositive() {
                            ...
                            (this@ShowPictureActivity as AppCompatActivity).doPermissionAction(
                                Manifest.permission.WRITE_EXTERNAL_STORAGE
                            ) {
                                doAfterGranted {
                                    Glide.with(this@ShowPictureActivity).asBitmap().load(url)
