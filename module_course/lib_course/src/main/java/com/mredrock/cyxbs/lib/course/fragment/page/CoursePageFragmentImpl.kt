...
open class CoursePageFragmentImpl : AbstractCoursePageFragment() {
   ...
   * 初始化触摸的折叠逻辑
   */
  protected open fun initTouchFoldLogic(course: ICourseLayout) {
    course.apply {
      // 折叠事件相关的 helper
      CourseFoldHelper.attach(course)
    }
  }
}