...
class CourseLayout @JvmOverloads constructor(
  ...
  defStyleRes: Int = 0
) : CourseTimeLineImpl(context, attrs, defStyleAttr, defStyleRes), ICourseLayout {
