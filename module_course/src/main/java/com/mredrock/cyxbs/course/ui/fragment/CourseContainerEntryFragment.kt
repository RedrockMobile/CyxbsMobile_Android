...
class CourseContainerEntryFragment : BaseViewModelFragment<CoursesViewModel>(), IUserStateService.StateListener, EventBusLifecycleSubscriber {
    ...
    private fun initFragment() {
        if (!accountService.getVerifyService().isLogin()) {
            ...
            fl.setSingleOnClickListener {}//处理所有未处理的点击事件，防止穿透点击或者滑动
        ...
        inflateListener = { inflate ->
            ...
            //回到本周按钮的点击事件
            course_back_present_week.setSingleOnClickListener {
        ...
        course_tv_now_course.setSingleOnClickListener {
    ...
    private fun initHead() {
        ...
        course_tv_which_week.setSingleOnClickListener { isShow() }
        course_this_week_tips.setSingleOnClickListener { isShow() }

        course_header_back.setSingleOnClickListener {
        ...
        course_header.setSingleOnClickListener {
