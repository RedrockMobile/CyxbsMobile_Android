...
import com.mredrock.cyxbs.course.page.find.viewmodel.fragment.FindStudentViewModel
 ...
 * @date 2022/2/8 17:03
 */
class FindStudentFragment : BaseVmFragment<FindStudentViewModel>() {
  ...
  ): View = inflater.inflate(R.layout.course_fragment_find_stu_course, container, false)
      ...
      .setOnDeleteClick {
        ...
        doIfLogin { // 登录才能使用
          if (viewModel.linkStudent.value?.linkNum == null) {
            ...
            ChooseDialog.Builder(this@FindStudentFragment)
              .setData(
                ChooseDialog.Data(
                  content = "你已有一位关联的同学\n确定要替换吗？",
                  width = 255.dp2px,
