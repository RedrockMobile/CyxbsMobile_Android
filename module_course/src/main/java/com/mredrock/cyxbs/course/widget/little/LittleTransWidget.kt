...
import com.mredrock.cyxbs.course.utils.filterClassRoom
import com.mredrock.cyxbs.course.utils.getClickPendingIntent
import com.mredrock.cyxbs.course.utils.getWeekDayChineseName
import com.mredrock.cyxbs.course.widget.page.trans.TransConfig
import java.util.*
...
class LittleTransWidget : BaseLittleWidget() {
    ...
    override fun getLayoutResId(): Int {//获取当前小工具适配的ID
        return R.layout.course_little_trans
    }
