package com.mredrock.cyxbs.todo.service
    ...
    class TodoWidgetFactory(val context: Context) : RemoteViewsFactory {
        ...
        private fun loadData() {
            ...
            scope.launch {
                ...
                val newTodoList =
                    TodoDatabase.instance.todoDao().queryAll()!!.filter { it.isChecked == 0 }
                        .sortedByDescending { it.todoId } // 获取待办事项列表
        ...
        override fun getViewAt(position: Int): RemoteViews {
            ...
            if (!todoList[position].remindMode.notifyDateTime.isNullOrEmpty()){
                item.setTextViewText(R.id.todo_widget_notify_time, todoList[position].remindMode.notifyDateTime)
            }else{
