 ...
 */
class CircleDynamicDataSource(private val kind: String, private val loop: Int) :
    PageKeyedDataSource<Int, Dynamic>() {
    ...
    class Factory(private val kind: String, private val loop: Int) :
        DataSource.Factory<Int, Dynamic>() {
