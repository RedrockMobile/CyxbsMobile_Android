...
class ReplyDetailAdapter(
    private val isReplyDetail: Boolean,
    ...
    private val onReplyMoreDetailClickEvent: (replyIdScreen: String) -> Unit
    ...
    inner class ReplyViewHolder(parent: ViewGroup) :
        BaseViewHolder<Comment>(parent, R.layout.qa_recycler_item_dynamic_reply_detail) {
        @SuppressLint("SetTextI18n")
        override fun refresh(data: Comment?) {
            data ?: return
            itemView.apply {
                qa_tv_reply_detail_date.text =
                ...
                qa_iv_reply_detail_praise_count_image.registerLikeView(
                    data.commentId,
